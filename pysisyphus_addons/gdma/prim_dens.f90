...
contains
   ...
   subroutine f_eval_prim_density(nprims, npoints, nbfs, Ls_inds, primdata, coords3d, &
                                P, switch, rho) bind(c, name="f_eval_prim_density")
   ...
   end subroutine f_eval_prim_density

end module mod_prim_dens
