module mod_pa_shells_wrapper
   ...
   use mod_pa_diabatization, only: contract_coulomb_densities_ao

   implicit none

contains

   subroutine f_contract_coulomb_densities_ao( &
      ...
      ) bind(c, name="f_contract_coulomb_densities_ao")
      ! AO basis
      ...
      call contract_coulomb_densities_ao(shells, shells_aux, densities, coulomb_tensor)

   end subroutine f_contract_coulomb_densities_ao
